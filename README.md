...
```
devtools::install_github("Model-R/modelr_pkg", ref = "andrea", build_vignettes = TRUE)
```
(`build_vignettes` will include this vignette on the installation, `ref = andrea` refers to this stable commit)
