...
```
    . models_dir
    | 
    |- _species_name             |- /projection1/ | - /partitions`  
       |                          | - /final_models`  
                                  | - /ensemble`  
                 |- /projection2/ | - /partitions`  
                                  | - /final_models`  
                                  | - /ensemble`  
```
...
final_model(species_name = species[1],
            ...
            select_par = "TSS",
            select_par_val = 0,
            weight_par = NULL, #in case we want to weigh the final result
            threshold = NULL, #for cut models (bin_mean, cut_mean)
            scale_models = T, #logical
...
sdmdata_files <- list.files("~/modelR_test/forlooptest", recursive = T, pattern = "sdmdata.txt", full.names = T)
