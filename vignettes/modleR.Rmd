...
knitr::include_graphics("fig01_workflow.jpg", dpi = 150)
```
...
```{r do_any_echo, echo = TRUE, eval = FALSE}
...
```{r do_any_eval, echo = FALSE, eval = TRUE, include = FALSE}
sp_maxnet <- do_any(species_name = species[1],
                    algorithm = "maxnet",
                    predictors = example_vars,
                    models_dir = test_folder,
...
```{r do_many_show, echo = TRUE, eval = FALSE, results = "hide", messages = FALSE}
...
```{r do_many_echo, echo = FALSE, eval = TRUE, include = FALSE, results= "hide", messages = FALSE}
many <- do_many(species_name = species[1],
                predictors = example_vars,
                models_dir = test_folder,
                png_partitions = TRUE,
...
knitr::include_graphics("fig05_finalmodel.png", dpi = 150)
```
...
```{r final, echo = TRUE, eval = TRUE, results = "hide"}
