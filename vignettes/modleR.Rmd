...
author: "Andrea Sánchez-Tapia, Diogo S. B. Rocha & Sara Mortara"
date: "`r Sys.Date()`"
output: 
...
library(purrr)
library(dplyr)
sdmdata_list <- coordenadas %>% purrr::map2(.x= ., 
                                            .y= as.list(names(.)), 
                                            ~ setup_sdmdata(species_name = .y,
                                                           ...
                                                           n_back = 1000))
#aqui nao funfa!!
coordenadas %>% purrr::pmap(.x = .,
                            .y = sdmdata_list,
                            ~ do_many(species_name = as.list(names(.)),
                                      sdmdata = .y,
                          occurrences = .x,
                          predictors = example_vars,
                          models_dir = "~/modleR_test/temp_purrr",
