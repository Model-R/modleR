...
#' a directory name, avoid non-ASCII characters, spaces and ponctuation marks.
...
#' @param predictors An object with the rasters to be cut.
...
#' @param geo_filt_dist The distance of the geographic filter in the unit of the predictor raster.
